...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="m-0"></h5>
                <a class="btn btn-primary" href="{{url('/sounds/create')}}"><i class="bx bx-plus me-0 me-sm-1"></i> Add Sound</a>
            </div>
        ...
        <tbody class="table-border-bottom-0">
            ...
            @foreach ($categories as $av)
            	<tr>
                    ...
                    <td>
                    	<a class="btn" href="sounds/{{$av->id}}/edit" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Edit"><i class="bx bx-edit"></i></a>
